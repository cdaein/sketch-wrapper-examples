        ...
        render({ context: ctx, width, height, playhead }) {
            ...
            for (let i = 0; i < numCircles; i++) {
                ...
                if (orientation === "h") {
                    ...
                    ctx.ellipse(x, height / 2, width / numCircles / 2, minDimension / 2, 0, 0, Math.PI * 2);
                }
                else {
                    const y = (height / (numCircles * 2)) * (i * 2 + 1);
                    ctx.ellipse(width / 2, y, minDimension / 2, height / numCircles / 2, 0, 0, Math.PI * 2);
                }
